...
#Il programma deve accettare in input un voto di laurea compreso tra 66 e 110, espresso come numero intero e usare un match per determinare il corrispondente GPA americano,
...
voto=(input("Inserici il voto di laurea:"))
if voto.isnumeric():
    voto=int(voto)
    ...
    print("errore scrivire un valore valido")